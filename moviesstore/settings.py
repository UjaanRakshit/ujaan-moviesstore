...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-27@72v%qbv!5p&q18jxno%7%=ljoz-m=tfb@3hmqruvj9)0i1t')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'moviesstore.context_processors.google_maps_api_key',
            ],
        },
    },
]
